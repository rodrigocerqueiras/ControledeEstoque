...
*/
$url = 'http://localhost/controleestoque/views/'; // Remova em caso de utilizar o código para hospedagem web 
...
<head>
  ...
  <title>Controle de Estoque | Infra2022</title>
...
<!-- Produtos -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="'.$url.'cliente/addcliente.php"><i class="fa fa-circle-o"></i>Add Escola</a></li>
  ...
  $footer = '<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022 <a href="https://www.linkedin.com/in/rodrigo-cerqueira-dos-santos-b4369071">Rodrigo Cerqueira - Dev.</a>.</strong> All rights
    reserved.
  </footer>
