              ...
              <form role="form" action="../../App/Database/insertcliente.php" method="POST">
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="NomeCliente" class="form-control" id="exampleInputEmail1" placeholder="Nome da Escola">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">INEP</label>
                    <input type="text" name="cpfCliente" class="form-control" id="exampleInputEmail1" placeholder="INEP">
                  </div>
                  <div class="form-group">
